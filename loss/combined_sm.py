...
def get_combined(cfg):
    ...
    return lambda func, function_parameters, data, pertubred_data, time, _z, key: yang_song(func, function_parameters, data, pertubred_data, time, _z, key) + dsm(func, function_parameters, data, pertubred_data, time, _z, key)
