...
def get_combined(cfg):
    ...
    return lambda func, function_parameters, data, pertubred_data, time, _z, text_embedding, key: yang_song(func, function_parameters, data, pertubred_data, time, _z, text_embedding,key) + 0.001 * dsm(func, function_parameters, data, pertubred_data, time, _z, text_embedding, key)
