...
def dataload(cfg):
    ...
    if name == 'mnist':
        ...
        training_generator = NumpyLoader(cifar10_dataset_test, batch_size=cfg.train_and_test.test.batch_size, shuffle=cfg.train_and_test.test.shuffle, num_workers=mp.cpu_count())
