...
# grad_call = jax.jit(jax.grad(loss2,0))
# grads2 = grad_call(model,x,y)

l,gt = jax.jit(jax.value_and_grad(loss2))(model,x,y)
print(l)

learning_rate = 0.1
model = jax.tree_util.tree_map(lambda m, g: m - learning_rate * g, model, gt)
