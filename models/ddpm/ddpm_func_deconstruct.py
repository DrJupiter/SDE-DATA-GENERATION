...
def get_ddpm_unet(cfg):
    ...
    def ddpm_unet(x_in, timesteps, parameters, key):
        ...
        # # Up ResNet 8
        # x = resnet_ff(jnp.concatenate([x,x_4_2],axis=-1), embedding, parameters,subkey=subkey.pop(), cfg=cfg, param_asso=param_asso, sub_model_num=8, local_num_shift = 0)
        ...
        # # Up ResNet 9
        # x = resnet_ff(jnp.concatenate([x,x_8_2],axis=-1), embedding, parameters,subkey=subkey.pop(), cfg=cfg, param_asso=param_asso, sub_model_num=9, local_num_shift = 0)
        ...
        # Up ResNet Attn 10
        x = resnet_ff(jnp.concatenate((x,x_16_2),axis=-1), embedding, parameters,subkey=subkey.pop(), cfg=cfg, param_asso=param_asso, sub_model_num=10, local_num_shift = 0)
        ...
        # Up ResNet 11
        x = resnet_ff(jnp.concatenate([x,x_32_2],axis=-1), embedding, parameters,subkey=subkey.pop(), cfg=cfg, param_asso=param_asso, sub_model_num=11, local_num_shift = 0)
