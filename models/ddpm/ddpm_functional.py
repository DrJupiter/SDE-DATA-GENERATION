...
def get_ddpm_unet(cfg, key, inference=False):
    ...
    def ddpm_unet(x_in, timesteps, text_embedding, params, key):
        ...
        text_embed = apply_text_embedding(text_embedding, params["p_text_embed"]) * float(cfg.model.guidance)
    ...
    def inf_ddpm_unet(x_in, timesteps, text_embedding, params, key):
        ...
        # Addition test
        _mean, cov = SDE.parameters(timesteps.reshape(len(timesteps), -1)*999, jnp.zeros_like(x_out))
