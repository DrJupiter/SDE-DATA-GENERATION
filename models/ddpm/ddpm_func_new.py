...
def get_ddpm_unet(cfg, key, inference=False):
    ...
    down1, p_d1, inf_down1 =       get_down(cfg, key, c_s[0], c_s[0], inference=inference)
    down2_attn, p_da2, inf_down2_attn = get_down_attn(cfg, key, c_s[0], c_s[1], inference=inference)
    down3, p_d3, inf_down3 =       get_down(cfg, key, c_s[1], c_s[2], inference=inference)
    down4, p_d4, inf_down4 =       get_down(cfg, key, c_s[2], c_s[3], inference=inference)

    r1, p_mr1, inf_r1 = get_resnet_ff(cfg, key, c_s[3], c_s[3], inference=inference)
    a1, p_ma2, inf_a1 = get_attention(cfg, key, c_s[3], c_s[3], inference=inference)
    r2, p_mr3, inf_r2 = get_resnet_ff(cfg, key, c_s[3], c_s[3], inference=inference)

    up1, p_u1, inf_up1 =         get_up(cfg, key, c_s[3], c_s[2], residual_C = [c_s[3],c_s[3],c_s[2]], inference=inference)
    up2, p_u2, inf_up2 =         get_up(cfg, key, c_s[2], c_s[2], residual_C = [c_s[2],c_s[2],c_s[1]], inference=inference)
    up_attn3, p_ua3, inf_up_attn3 =   get_up_attn(cfg, key, c_s[2], c_s[1], residual_C = [c_s[1],c_s[1],c_s[0]], inference=inference)
    up4, p_u4, inf_up4 =         get_up(cfg, key, c_s[1], c_s[0], residual_C = [c_s[0],c_s[0],c_s[0]], inference=inference)
    ...
    def ddpm_unet(x_in, timesteps, text_embedding, params, key):
        ...
        x_32_1, x_32_2, x_16_0 = down1(x_32_0, embed, params["p_d1"], subkey, factor=1)
        x_16_1, x_16_2, x_8_0 = down2_attn(x_16_0, embed, params["p_da2"], subkey, factor=1)
        x_8_1, x_8_2, x_4_0 = down3(x_8_0, embed, params["p_d3"], subkey, factor=1)
        ...
        x = up1(x, x_4_2, x_4_1, x_4_0, embed, params["p_u1"], subkey, factor=1)
        x = up2(x, x_8_2, x_8_1, x_8_0, embed, params["p_u2"], subkey, factor=1)
        x = up_attn3(x, x_16_2, x_16_1, x_16_0, embed, params["p_ua3"], subkey, factor=1)
    ...
    def inf_ddpm_unet(x_in, timesteps, text_embedding, params, key):
        ...
        x_32_1, x_32_2, x_16_0 = inf_down1(x_32_0, embed, params["p_d1"], subkey, factor=1)
        x_16_1, x_16_2, x_8_0 = inf_down2_attn(x_16_0, embed, params["p_da2"], subkey, factor=1)
        x_8_1, x_8_2, x_4_0 = inf_down3(x_8_0, embed, params["p_d3"], subkey, factor=1)
        x_4_1, x_4_2, x = inf_down4(x_4_0, embed, params["p_d4"], subkey, factor=1)

        x = inf_r1(x, embed, params["p_mr1"], subkey)
        x = inf_a1(x, embed, params["p_ma2"], subkey)
        x = inf_r2(x, embed, params["p_mr3"], subkey)

        # x = jax.lax.with_sharding_constraint(x, sharding)

        x = inf_up1(x, x_4_2, x_4_1, x_4_0, embed, params["p_u1"], subkey, factor=1)
        x = inf_up2(x, x_8_2, x_8_1, x_8_0, embed, params["p_u2"], subkey, factor=1)
        x = inf_up_attn3(x, x_16_2, x_16_1, x_16_0, embed, params["p_ua3"], subkey, factor=1)
        x = inf_up4(x, x_32_2, x_32_1, x_32_0, embed, params["p_u4"], subkey, factor=1)
